...
<head>
  ...
  <title><?php echo $title; ?> &mdash;</title>
    ...
    <link rel="icon" type="image/png" sizes="72x72"  href="<?php echo base_url(); ?>assets/favicon/favicon-32x32.ico">
...
<?php
  ...
  $this->load->view('homepage/_partials/layout-3');
  $this->load->view('homepage/_partials/navbar');
