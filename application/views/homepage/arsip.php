                    ...
                    <div class="row">
                            ...
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4" role="tab"
                                        aria-controls="profile" aria-selected="false">Peraturan
                                        Senat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#contact4" role="tab"
                                        aria-controls="contact" aria-selected="false">Refrensi
                                        Senat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#komisid" role="tab"
                                        aria-controls="contact" aria-selected="false">Ketentuan
                                        Lain</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#sambutan" role="tab"
                                        aria-controls="contact" aria-selected="false">Sambutan
                                        Pemimpin Senat</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 col-sm-12 col-md-8">
                            <div class="tab-content no-padding" id="myTab2Content">
                                ...
                                <div class="tab-pane fade" id="sambutan" role="tabpanel" aria-labelledby="contact-tab4">
