    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Tentang Senat</div>
            </div>
        </div>
                            ...
                            <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4" role="tab"
                                        aria-controls="profile" aria-selected="false">Visi &
                                        Misi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="strukturtab" data-toggle="tab" href="#struktur" role="tab"
                                        aria-controls="struktur" aria-selected="false">Struktur
                                        Organisasi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="anggotatab" data-toggle="tab" href="#anggota" role="tab"
                                        aria-controls="anggota" aria-selected="false">Anggota
                                        Senat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="anggotatab" data-toggle="tab" href="#sekretariat" role="tab"
                                        aria-controls="anggota" aria-selected="false">Sekretariat</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="tab-pane fade show active" id="home4" role="tabpanel"
                                    ...
                                    <ol style="text-align: justify;">
                                        ...
                                        <li>
                                            ...
                                            akademika yang diusulkan direktur;
                                        </li>
                                        <li>
