...
<div class="form-group">
    ...
    <input class="form-control" name="agenda" type="text" placeholder="Masukkan agenda Anda..."
        value="Rapat <?php echo $usulan->jenis;?>" required>
</div>
<?php } ?>
...
<div class="form-group">
    <label>Agenda</label><br>
    <input class="form-control" name="agenda" type="text" placeholder="Masukkan agenda Anda..." value="Sidang Pleno"
        required>
</div>
<?php } ?>
...
<div class="form-group">
    <label>Agenda</label><br>
    <input class="form-control" name="agenda" type="text" placeholder="Masukkan agenda Anda..." value="Sidang Paripurna"
        required>
</div>
<?php } ?>
...
<div class="form-group">
    <label>Agenda</label><br>
    <input class="form-control" name="agenda" type="text" placeholder="Masukkan agenda Anda..." value="Rapat Komisi"
        required>
</div>
<?php } ?>
